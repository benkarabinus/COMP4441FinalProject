...
### Time Series Analysis Using Seasonal Autoregressive Integrated Moving Average SARIMA Model
...
The above equation represents whats commonly referred to as an AR(1) model. An autoregressive model using a single lag to predict future values of Y, the outcome. 
